...
//           <Link to={`/startservicing2/${bookingDetails._id}`} className='mt-[40px] flex items-center cursor-pointer justify-center font-Montserrat text-[14px] font-[500] text-[#8D98A4]'>Later</Link>
//         </div>
//       </div>
//     </div>
//   );
    ...
    <div className='absolute top-0 left-0 w-full h-[1015px] flex items-center justify-center bg-black bg-opacity-40 z-30'>
      <div className='absolute -ml-[208px] left-1/2 transform -translate-x-1/2 -translate-y-1/2 mt-[96px] z-30 '>
        <div className='sm:w-[600px] mb-40  w-[300px] h-auto p-[32px] bg-white rounded-2xl ml-[420px] relative z-30' >
          ...
          <Link to={`/startservicing2/${bookingId}`} className='mt-[40px] flex items-center cursor-pointer justify-center font-Montserrat text-[14px] font-[500] text-[#8D98A4]'>Later</Link>
