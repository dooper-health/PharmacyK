...
// import SuccessCardotpstartservice from '../components/SuccessCardotpstartservice';
...
//     axios.post(`/api/sd/completemedicine/${bookingId}`)
//       .catch(error => {
...
//     try {
//       const response = await fetch(`/api/otp/check-otp/${bookingId}`, {
//         method: 'POST',
...
//   const [onOtpSuccess, setOnOtpSuccess] = useState(false);

//   const handleOtpSuccess = () => {
//     console.log("OTP verified, updating state...");
//     setOnOtpSuccess(true);
//   };

//   console.log("onOtpSuccess state:", onOtpSuccess);

//   return (
//     <>
//       {onOtpSuccess ? <SuccessCard /> : <OtpCard onOtpSuccess={handleOtpSuccess} />}
//     </>
//   );
// };
...
//     console.log('Sending OTP:', otpString);
//     try {
//       const response = await fetch(`/api/otp/checkotp/${bookingId}`, {
//         method: 'POST',
//         headers: { 'Content-Type': 'application/json' },
//         body: JSON.stringify({ otp: otpString }),
//       });
