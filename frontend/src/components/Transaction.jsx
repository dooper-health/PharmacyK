...
const Transaction = ({earnapi,withcardnavigate}) => {
...
const handleWithdraw = async () => {
  try {
    ...
    navigate(withcardnavigate.withdraw); // Updated navigation
  } catch (error) {
  ...
  <div className='w-full '>
    ...
    <main className=' sm:mx-[120px] mx-[5px] pt-[24px] pb-[48px] overflow-x-hidden'>
      ...
      <Link to="/myprofile">
        ...
        <div className='flex flex-wrap'>
          ...
          <div className='sm:p-[20px] p-[10px] sm:bg-white  sm:w-[200px] w-[150px] sm:mt-[16px] mt-[30px] rounded-lg ml-4 '>
            ...
            <input 
              ...
              className='sm:ml-0 ml-4 px-[16px] py-[12px] md:w-[370px] w-[155px] h-[44px] items-center rounded-lg border border-[#E2E2E2] mt-[16px] font-Montserrat text-[14px] font-medium mr-3'
            />
            <button 
              onClick={handleWithdraw} 
              className='inline-block mx-auto text-center px-[16px] py-[12px] md:w-[370px] w-[155px] h-[44px] items-center rounded-lg bg-[#E40443] mt-[16px] text-white font-Montserrat text-[14px] font-medium'
            >
              Withdraw
            </button>
        ...
        >
          <Link to={withcardnavigate.withdrawbutton}> Withdrawals</Link>
        </li>
        </div>
      ...
      <hr className='lg:block hidden sm:ml-0 ml-[60px] mt-[22px] border border-[#E1E5E8]' />
            <div className='sm:flex sm:flex-row flex-col mt-[64px]'>
              <TransactionCard />
              <Paymentstatus/>
            </div>
          </main>
