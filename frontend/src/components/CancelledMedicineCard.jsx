...
//             {booking.patientName}
//           </h1>
//           <p className='mx-10 px-6 bg-[#ffc0c0] rounded-full'>Cancelled</p>
//           </div>
...
//       try {
//         const response = await axios.get('/api/sd/pendingvaccine');
        ...
        <div className="flex gap-[16px] justify-center items-center py-[14px] px-[16px] border-b-[1px] border-[#E4E4E4]">
          ...
          <div className="font-Montserrat">
            <div className='flex gap-10'>
              ...
              {/* <p className='mx-10 px-6 bg-[#ff0000] rounded-full'>Cancelled</p> */}
              <p className='mx-10 px-6 bg-[#FFDFE8] rounded-full text-[#FF0000]'>Cancelled</p>
...
const BookingsList = () => {
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      try {
        const response = await axios.post('/api/sd/cancelledmedicine', { labownermobile: mobileNumber });
