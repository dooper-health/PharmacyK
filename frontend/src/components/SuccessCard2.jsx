...
const SuccessCard2 = () => {
  ...
  return (
    ...
    <div className='sm:w-[600px] w-[300px] h-auto p-[32px] bg-white rounded-2xl ml-[420px] relative z-30' >
    ...
    <Link to={`/dashboardbooking2`} className='mt-[40px] flex items-center cursor-pointer justify-center font-Montserrat text-[14px] font-[500] text-[#8D98A4]'>Later</Link>
