...
// import ReportCard22 from './ReportCard22';
...
// const AddReportCard2 = ({ incrementCompletedBookings }) => {
//   const [showReportCard2, setShowReportCard2] = useState(false);
...
//   const openReportCard2 = () => {
//     setShowReportCard2(true);
//   };

//   const closeReportCard2 = () => {
//     setShowReportCard2(false);
//   };
...
//               </div>
//               {showReportCard2 && (
//                 <ReportCard22 onClose={closeReportCard2} onUploadSuccess={handleUploadSuccess} />
//               )}
//               {showSuccessCard && (
//                 <SuccessCard />
//               )}
...
//                 <h2 className='flex font-Montserrat text-[12px] font-medium mt-[8px] w-[345px]'><img src={cal} alt="cal" className='h-4 w-4 mr-[7px]' />13 June, 2023</h2>
//                 <h3 className='flex font-Montserrat text-[12px] font-medium -mt-[19px] sm:ml-[372px] ml-[200px]'><img src={clock} alt="cal" className='h-4 w-4 mr-[7px] mt-[1px]' />9 : 00 AM</h3>
//               </div>
...
//                 </div>
//                 <button onClick={openReportCard2} className='ml-[12px] h-[36px] w-auto bg-[green] text-[13px] font-[600] font-Montserrat text-white rounded-lg items-center justify-center px-[24px]'>Add Quatation</button>
//               </div>
//             </div>
//           </main>
//         </div>
          ...
          <main className='sm:mx-[120px] pt-[24px] pb-[48px] overflow-x-hidden'>
            ...
            <div className='h-auto w-[774px] mt-[8px] rounded-2xl border-t bg-white'>
              ...
              <div className='h-[84px] py-[20px] px-[20px] border-t-[#EEF0F3]'>
               ...
               {/* <button onClick={openReportCard2} className='ml-[12px] h-[36px] w-auto bg-[green] text-[13px] font-[600] font-Montserrat text-white rounded-lg items-center justify-center px-[24px]'>Add Quotation</button> */}
               <div className="py-[10px] border border-t-[#EEF0F3]">
                {showPrescriptionPopup && (
                  <Prescription
