...
const SuccessCardotpstartservice = () => {
  ...
  return (
    ...
    <Link to={`/incoming`} className='mt-[40px] flex items-center cursor-pointer justify-center font-Montserrat text-[14px] font-[500] text-[#8D98A4]'>Later</Link>
...
export default SuccessCardotpstartservice
