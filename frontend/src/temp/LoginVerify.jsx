    ...
    <div className='flex flex-col bg-[#FFFFFF]'>
      <div className='flex flex-col sm:max-w-[480px] mx-auto p-8'>
        <div className='text-center'>
          <h1 className='font-Montserrat text-2xl font-[700] leading-[44px]'>Verify</h1>
          ...
          <button
            ...
            className='inline-block h-[44px] sm:w-[416px] w-[340px] rounded-[8px] bg-[#E40443] text-center mx-auto mt-[16px] justify-center font-Montserrat text-[14px] font-[600] leading-[116%] text-white py-[15px]'
          >
            Verify OTP
          </button>
        </div>
